                ...
                "messages": [{
                    ...
                    "content": [
                        ...
                        {"type": "text", "text": (
                            ...
                            "Also reject an extreme close-up zoom even if a small sliver of a road "
                            "edge, line marking, or similar is technically visible in one corner or "
                            "patch — if the large majority of the frame is just an indistinct, "
                            "blurry close-up texture (grass, dirt, gravel, pavement asphalt, "
                            "fabric-like blur) with no genuinely LEGIBLE, USEFUL wider context "
                            "(a visible road running through the scene, sky, horizon, building, "
                            "sign, vehicle, or similar recognizable object taking up a real part "
                            "of the frame), that still fails — a technically-present sliver isn't "
                            "the same as a genuinely useful reference photo. GeoGuessr's OWN "
