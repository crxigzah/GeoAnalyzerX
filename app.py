                ...
                "messages": [{
                    ...
                    "content": [
                        ...
                        {"type": "text", "text": (
                            ...
                            "4. Whether it's otherwise a genuine, USEFUL outdoor Street View "
                            "scene at all — not a selfie, menu/loading screen, blank/black frame. "
                            "Also reject an extreme close-up zoom that shows ONLY a flat patch of "
                            "ground/pavement filling almost the whole frame, even if it's sharp "
                            "and in-focus and even if a road edge or line marking is visible "
                            "within it — a close-up of just asphalt-with-lines, grass, dirt, or "
                            "gravel is NOT enough on its own. Require genuine WIDER scene context "
                            "beyond the ground surface itself: sky, a horizon line, a building, "
                            "vegetation/trees at a normal (non-macro) distance, a sign, a vehicle, "
                            "or the road clearly extending away into the distance rather than just "
                            "filling the foreground. If the shot is essentially 'looking straight "
                            "down/forward at the ground from close range' with none of that wider "
                            "context, reject it — a technically-visible line painted on the ground "
                            "isn't the same as a genuinely useful reference photo. GeoGuessr's OWN "
                            "normal compass strip, round/score display, zoom controls, and logo "
                            "are all fine regardless.\n\n"
