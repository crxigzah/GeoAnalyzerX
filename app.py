                ...
                "messages": [{
                    ...
                    "content": [
                        ...
                        {"type": "text", "text": (
                            ...
                            "exposure — but NOT the extreme sharpness of Gen 4 below. Camera "
                            ...
                            "highlights. This is the most common generation — if nothing distinctive "
                            "from the other generations is present and it just looks like a normal "
                            "clear photo without Gen 4's extreme sharpness, this is the most likely "
                            "answer, not a coin-flip default.\n"
                            "GEN 4 (2017-present): The key tests are RESOLUTION and STITCHING, not "
                            "just 'looks nice' — look for genuinely extreme sharpness where individual "
                            "bricks on a building, fine texture in road surfaces, or small text on "
                            "distant signs are actually legible, and camera stitching seams are "
                            "nearly invisible (the image looks like one continuous photo, not a "
                            "composite). Also handles shots facing directly into the sun well, "
                            "without washed-out highlights, unlike Gen 3. If you can't point to "
                            "genuinely extreme fine detail like that, prefer Gen 3 instead — 'brighter "
                            "colors' alone is not a reliable enough signal on its own.\n"
